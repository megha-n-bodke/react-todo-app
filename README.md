...
- React ToDo app is a SPA Created with create react app.It facilitates user to Create todo list and maintaint it.

## [Click to See the Todos App](https://github.com/megha-n-bodke/react-todo-app/)
...
```
git clone https://github.com/megha-n-bodke/react-todo-app
```
